    ...
    public unsafe class MethodHook
    {
        ...
        private void CheckMethod()
        {
...

            {
                ...
                {
                    int codeSize =
 _targetMethod.GetMethodBody().GetILAsByteArray().Length; // GetMethodBody can not call on il2cpp
        ...
        private IntPtr GetFunctionAddr(MethodBase method)
        {
            ...
            else
            {
                ...
                if(sizeof(IntPtr) == 8)
                {
                    ...
                    byte* ptrData =
 (byte *)methodDataAddr + sizeof(IntPtr) * 2; // offset of Il2CppReflectionMethod::const MethodInfo *method;
