...
#if USE_LUA
#region mono hook
private static MethodHook luaL_newstate_hook = null;
private static MethodHook lua_close_hook = null;
private static MethodHook luaL_ref_hook = null;
private static MethodHook luaL_unref_hook = null;
private static MethodHook luaL_loadbuffer_hook = null;
private static MethodHook toluaL_ref_hook = null;
private static MethodHook toluaL_unref_hook = null;
        ...
        private static object m_Lock = 1;
            ...
            public static void Install()
            {
                ...
                luaL_newstate_hook = BindHook(oldType, replaceType, "luaL_newstate", "luaL_newstate_replace", "luaL_newstate_proxy");
   
                lua_close_hook = BindHook(oldType, replaceType, "lua_close", "lua_close_replace", "lua_close_proxy");

                luaL_ref_hook = BindHook(oldType, replaceType, "luaL_ref", "luaL_ref_replace", "luaL_ref_proxy");

                luaL_unref_hook = BindHook(oldType, replaceType, "luaL_unref", "luaL_unref_replace", "luaL_unref_proxy");
            
    #if TOLUA
                luaL_loadbuffer_hook = BindHook(oldType, replaceType, "luaL_loadbuffer", "luaL_loadbuffer_replace", "luaL_loadbuffer_proxy");
    #elif XLUA
                luaL_loadbuffer_hook = BindHook(oldType, replaceType, "xluaL_loadbuffer", "luaL_loadbuffer_replace", "luaL_loadbuffer_proxy");
    #elif SLUA
                oldType = typeof(SLua.LuaDLLWrapper);
                luaL_loadbuffer_hook = BindHook(oldType, replaceType, "luaLS_loadbuffer", "luaL_loadbuffer_replace", "luaL_loadbuffer_proxy");
    #endif
            
    #if TOLUA
                toluaL_ref_hook = BindHook(oldType, replaceType, "toluaL_ref", "toluaL_ref_replace", "toluaL_ref_proxy");
                toluaL_unref_hook = BindHook(oldType, replaceType, "toluaL_unref", "toluaL_unref_replace", "toluaL_unref_proxy");
        ...
        public static void UnInstall()
        {
            ...
            {
                toluaL_ref_hook.Uninstall();
            }
            if (toluaL_unref_hook != null)
            {
                toluaL_unref_hook.Uninstall();
            }
            #endif
            m_hooked = true;
        }
