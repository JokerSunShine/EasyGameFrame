    ...
    public class LuaProfilerTreeView : TreeView
    {
        ...
        private static MultiColumnHeader CreateDefaultMultiColumnHeaderState(float treeViewWidth)
        {
            var columns = new[]
            {
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("tm_self"),
                    contextMenuText = "tm_self",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 60,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("tl_self"),
                    contextMenuText = "tl_self",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 60,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("ct_self"),
                    contextMenuText = "ct_self",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 60,
            ...
            if(LuaProfilerPrecompileSetting.Instance.visibleColumns.Count!=0)
            {
                state.visibleColumns = LuaProfilerPrecompileSetting.Instance.visibleColumns.ToArray();
            }
