...
namespace ProtoBuf.Serializers
{
    ...
    {
        public static bool isOnlyOneProperty = false;
        ...
        public void Write(object value, ProtoWriter dest)
        {
            ...
            TypeSerializer.isOnlyOneProperty = serializers.Length == 1;
            //UnityEngine.Debug.Log("TypeSerializer.isOnlyOneProperty = " + TypeSerializer.isOnlyOneProperty);
            for (int i = 0; i < serializers.Length; i++)
            {
                IProtoSerializer ser = serializers[i];
