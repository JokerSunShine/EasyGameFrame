...
;
        ...
        public override void Write(object value, ProtoWriter dest)
        {
            ...
            //UnityEngine.Debug.Log("writePacked = " + writePacked);
            //UnityEngine.Debug.Log("subItemCount = " + subItemCount);
            //UnityEngine.Debug.Log("isOnlyOneProperty = " + TypeSerializer.isOnlyOneProperty);
            if (!writePacked && TypeSerializer.isOnlyOneProperty && subItemCount == 0)
            {
                ProtoWriter.WriteFieldHeader(fieldNumber, WireType.String, dest);
                token = ProtoWriter.StartSubItem(value, dest);
                ProtoWriter.SetPackedField(fieldNumber, dest);
