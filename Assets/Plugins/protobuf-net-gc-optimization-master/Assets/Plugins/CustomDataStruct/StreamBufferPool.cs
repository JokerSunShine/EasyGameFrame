...
namespace CustomDataStruct
{
    ...
    {
#if UNITY_EDITOR
        private static MemoryLeakDetecter streamDetecter = MemoryLeakDetecter.Add(typeof(StreamBuffer).FullName, 100, 100);
        private static MemoryLeakDetecter bufferDetecter = MemoryLeakDetecter.Add(typeof(byte[]).FullName, 500, 1000);
#endif
        private const int BUFFER_POOL_SIZE = 500;
        private static Dictionary<int, Queue<StreamBuffer>> streamPool = new Dictionary<int, Queue<StreamBuffer>>();
