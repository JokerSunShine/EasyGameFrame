...
{
    public static class BetterDelegate
    {
        private static List<IDelegateBase> instanceList = new List<IDelegateBase>();

        private static void Add(IDelegateBase delagateAction)
        {
            lock (instanceList)
            {
                instanceList.Add(delagateAction);
            }
        }

        private static void Remove(IDelegateBase delagateAction)
        {
            lock (instanceList)
            {
                instanceList.Remove(delagateAction);
            }
        }
        ...
        public static IDelegateAction GetAction(Delegate callback)
        {
        ...
        public static IDelegateAction GetAction<T>(Delegate callback, T arg1)
        {
        ...
        public static IDelegateAction GetAction<T, U>(Delegate callback, T arg1, U arg2)
        {
        ...
        public static IDelegateAction GetAction<T, U, V>(Delegate callback, T arg1, U arg2, V arg3)
        {
        ...
        private static void LogError(Type delType, params Type[] p)
        {
        ...
        private static void LogError(string delName, string[] argNames)
        {
...
#if UNITY_EDITOR
            private static MemoryLeakDetecter detecter = MemoryLeakDetecter.Add(typeof(Queue<DelegateAction>).FullName, 100, 100);
#endif
            private static Queue<DelegateAction> pool = new Queue<DelegateAction>(32);
        ...
        private class DelegateAction<T> : IDelegateBase
        {
            private const int POOL_SIZE_LIMIT = 100;
#if UNITY_EDITOR
            private static MemoryLeakDetecter detecter = MemoryLeakDetecter.Add(typeof(DelegateAction<T>).FullName, 100, 100);
#endif
            private static Queue<DelegateAction<T>> pool = new Queue<DelegateAction<T>>(32);
            public Delegate mCallback;
            public T mArg1;
        ...
        private class DelegateAction<T, U> : IDelegateBase
        {
            private const int POOL_SIZE_LIMIT = 100;
#if UNITY_EDITOR
            private static MemoryLeakDetecter detecter = MemoryLeakDetecter.Add(typeof(DelegateAction<T, U>).FullName, 100, 100);
#endif
            private static Queue<DelegateAction<T, U>> pool = new Queue<DelegateAction<T, U>>(32);
            public Delegate mCallback;
            public T mArg1;
            public U mArg2;
        ...
        private class DelegateAction<T, U, V> : IDelegateBase
        {
            private const int POOL_SIZE_LIMIT = 100;
#if UNITY_EDITOR
            private static MemoryLeakDetecter detecter = MemoryLeakDetecter.Add(typeof(DelegateAction<T, U, V>).FullName, 100, 100);
#endif
            private static Queue<DelegateAction<T, U, V>> pool = new Queue<DelegateAction<T, U, V>>(32);
            public Delegate mCallback;
            public T mArg1;
            public U mArg2;
            public V mArg3;
