...
namespace CustomDataStruct
{
    public sealed class MemoryLeakDetecter
    {
        ...
        private int USING_LIMIT = 1000;
        private int POOL_LIMIT = 1000;
        private int CHECK_PENDING_MS = 1000;//为了防止抖动，只有在这个时间内状态持续才认为内存已经泄露
        private string MODULE_NAME = string.Empty;
        private int inUsingCount = 0;
        private int poolCount;
        private System.Diagnostics.Stopwatch sw = new System.Diagnostics.Stopwatch();
        private System.Diagnostics.Stopwatch sw2 = new System.Diagnostics.Stopwatch();
        private long curStartTime = 0;
        private long curStartTime2 = 0;
        private bool hasUsingLeaks = false;

        private MemoryLeakDetecter()
        {
        }

        public static MemoryLeakDetecter Add(string moduleName, int usingLimit = 1000, int poolLimit = 1000,
        ...
        public static void Remove(MemoryLeakDetecter detecter)
        {
            if (detecter == null)
            {
                return;
        ...
        private bool Check(System.Diagnostics.Stopwatch sw, bool pending, ref long startTime)
        {
