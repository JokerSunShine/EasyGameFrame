...
namespace MikuLuaProfiler
{
    ...
    public class LuaDeepProfilerSetting : ScriptableObject
    {
        ...
        public bool isOpenLuaProfiler
        {
            get
            {
                return LuaDeepProfilerAssetSetting.Instance.isOpenLuaProfiler;
            }
            set
            {
                LuaDeepProfilerAssetSetting.Instance.isOpenLuaProfiler = value;
            }
        }
        ...
        public string luaDirName
        {
            get
            {
                if (string.IsNullOrEmpty(m_luaDirName))
                {
                    if(m_luaDir.Count == 1)
                    {
                        if(System.IO.Directory.Exists(m_luaDir[0]))
                        {
                            System.IO.DirectoryInfo dirInfo = new System.IO.DirectoryInfo(m_luaDir[0]);
                            m_luaDirName = dirInfo.Name;
                        }
                    }
                }
                return m_luaDirName;
